...
// TODO: INSTALAR CUIDADOSAMENTE Y AHORA MISMO TYPESCRIPT
// E IR HACIENDO LOS CURSOS DE PLURALSIGHT. SI ES POSIBLE.
        ...
        <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            ...
            <div id="profile"
                ...
                <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <h1 class="text-3xl font-bold pt-8 lg:pt-0">Mariano Rodriguez</h1>
                    ...
                    <p class="pt-4 text-base font-semibold flex items-center justify-center lg:justify-start">
                        ...
                        </svg>Senior Software Developer | UI/UX Designer</p>
                    ...
                    <p class="pt-8 text-sm">I'm a Software Developer experienced in several programming languages and industries</p>
                    <p class="pt-8 text-sm">I have great interest in UI/UX Design as complement to my frontend and general design skills. The mix between art and science always fascinated me.</p>
                    
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16"><path fill="#FFCCEE" d="M.471 0L0 .471 2.828 3.3 5.657.47 5.185 0 2.828 2.357.471 0z"></path></svg>
            ...
            <div class="w-full lg:w-2/5">
                ...
                <img src={largePortrait} alt="mr" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" />
            </div>
