            ...
            <div id="profile"
                ...
                <div className="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <p className="pt-4 text-base font-semibold flex justify-center lg:justify-start">
                        <svg className="h-4 fill-current text-accent pr-4" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
                    ...
                    <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start"><svg
                        className="h-4 fill-current text-accent pr-4" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
