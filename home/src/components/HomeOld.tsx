...
function Home() {
    return (
        <div className="items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0 py-5">
        {/* <div className="max-w-4xl items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0 py-5"></div> */}
            <div className="container px-4 mx-auto">
                <div className="flex flex-wrap">
                    <div className="w-1/3 px-2">
                        
                        <span className="text-sm block my-4 p-3 text-blueGray-700 rounded border border-solid border-blueGray-100">Main</span>
            ...
            <div id="profile"
                ...
                <div className="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <div className="w-1/6 px-2">
                        ...
                        <span className="text-sm block my-4 p-3 text-blueGray-700 rounded border border-solid border-blueGray-100">Secundaria</span>
                        <Footer />
                    </div>
                </div>
            </div>
